...
import br.com.projetobt.dao.ClienteDao;
import br.com.projetobt.modelos.Cliente;
import br.com.projetobt.modelos.FuncionarioSingleton;
import br.com.projetobt.modelos.ModeloTabela;
import br.com.projetobt.util.VerificaTela;
...
public class FormConsultarCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTF_Consulta, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 190, 340, 50));
        ...
        getContentPane().add(jBT_Pesquisar, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 190, 200, 50));
        ...
        getContentPane().add(jBT_Alterar, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 90, 230, 70));
        ...
        getContentPane().add(jBT_CadastrarPedido, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 90, 230, 70));
        ...
        getContentPane().add(jBT_Excluir, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 90, 210, 70));
    ...
    private void jBT_CadastrarPedidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBT_CadastrarPedidoActionPerformed
        ...
        FormCadProduto.idCliente = idCliente;
        dispose();
    ...
    private void jLB_FecharMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLB_FecharMouseReleased
        VerificaTela.chamarTela(FuncionarioSingleton.getFuncionario().getUsuario().getPerfil().getIdPerfil(), this);
